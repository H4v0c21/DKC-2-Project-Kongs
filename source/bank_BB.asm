...
;	BEQ palette_is_dixie_palette		;$BB8B87   |
	BEQ palette_is_second_kong_palette
	RTS					;$BB8B89  /
...
second_kong_palette_current_kong_leader:
	LDA $091C				;$BB8B8F   |
	AND #$0003				;$BB8B92   |
...
first_kong_palette_current_kong_leader:		;	   |
	LDA $091A				;$BB8BAF   |
...
;START OF PATCH (store kong status to buffer in 2p contest)
	PHY
	LDX #$025A
	LDY #$0262
	LDA kong_status
...
;START OF PATCH (load kong status from buffer in 2p contest)
	PHY
	LDX #$025A
	LDY #$0262
	LDA [$26],y
	BNE .kong_status_not_0
	LDA #$01
	STA kong_status+1
	LDA #$00
	STA kong_status
