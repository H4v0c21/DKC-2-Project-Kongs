...
;	LDA $05A7
;	CMP #$6484
;	BEQ palette_is_diddy_palette
;	CMP #$6574
;	BEQ palette_is_dixie_palette
;	CMP #donkey_player_palette
;	BEQ palette_is_donkey_palette
;	CMP #kiddy_player_palette
;	BEQ palette_is_kiddy_palette
;	RTS
...
;invincible
	...
	CMP #$6574				;$BB8B84   |
	BEQ palette_is_dixie_palette		;$BB8B87   |
	RTS					;$BB8B89  /

palette_is_diddy_palette:
	LDA $08A4				;$BB8B8A  \
	BEQ diddy_palette_current_kong_diddy	;$BB8B8D   |
	
dixie_palette_current_kong_diddy:		;	   |
	LDA $091C				;$BB8B8F   |
	AND #$0003				;$BB8B92   |
	BEQ inactive_palette_effect		;$BB8B95   |
	DEC A					;$BB8B97   |
	BEQ frozen_palette_effect		;$BB8B98   |
	DEC A					;$BB8B9A   |
	BEQ slowed_palette_effect		;$BB8B9B   |
	BRA inverted_palette_effect		;$BB8B9D  /

inactive_palette_effect:
	LDA #$001E				;$BB8B9F  \
	CLC					;$BB8BA2   |
	ADC $05A7				;$BB8BA3   |
	CLC					;$BB8BA6   |
...
palette_is_dixie_palette:
	LDA $08A4				;$BB8BAA  \
	BEQ dixie_palette_current_kong_diddy	;$BB8BAD   |
	
diddy_palette_current_kong_diddy:		;	   |
	LDA $091A				;$BB8BAF   |
	BMI invincible_palette_effect		;$BB8BB2   |
	LDA $091C				;$BB8BB4   |
	AND #$0003				;$BB8BB7   |
	BEQ no_palette_effect			;$BB8BBA   |
	DEC A					;$BB8BBC   |
	BEQ frozen_palette_effect		;$BB8BBD   |
	DEC A					;$BB8BBF   |
	BEQ slowed_palette_effect		;$BB8BC0   |
inverted_palette_effect:			;	   |
	LDA #$00B4				;$BB8BC2   |
	CLC					;$BB8BC5   |
	ADC $05A7				;$BB8BC6   |
	RTS					;$BB8BC9  /
...
frozen_palette_effect:
	LDA #$0078				;$BB8BD1  \
	CLC					;$BB8BD4   |
	ADC $05A7				;$BB8BD5   |
	RTS					;$BB8BD8  /

slowed_palette_effect:
	LDA #$0096				;$BB8BD9  \
	CLC					;$BB8BDC   |
	ADC $05A7				;$BB8BDD   |
	RTS					;$BB8BE0  /

invincible_palette_effect:
	LDA #$00D2				;$BB8BE1  \
	CLC					;$BB8BE4   |
	ADC $05A7				;$BB8BE5   |
	RTS					;$BB8BE8  /
...
;START OF PATCH (in-game kong object init)
CODE_BBAD34:
	LDA #$6682				;$BBAD34  \
...
;donkey
	...
	;LDY #$000E
	LDY #$005A; index to init script table entry
...
;kiddy
	...
	;LDY #$0010
	LDY #$005C ;index to init script table entry
...
;START OF PATCH (add branch to check Dixie Kong object type instead of assuming everyone who isn't Diddy is Dixie)
	...
	BNE check_donkey							;If not Dixie, proceed to checking Donkey's object type
;END OF PATCH
...
check_donkey:
	...
	BNE kiddy									;If not Donkey, Kiddy is the only other option
	LDA #$008C									;$008C = Donkey palette ID
	BRA load_donkey_kiddy_palette
kiddy:
	LDA #$008D									;$008D = Kiddy palette ID
load_donkey_kiddy_palette:
	JSR CODE_BB8A69
	BRA CODE_BBAED7
;END OF PATCH
