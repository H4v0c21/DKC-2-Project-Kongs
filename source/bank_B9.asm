...
CODE_B9D03A:
	...
	CLC					;$B9D046   |
	ADC $26					;$B9D047   |
	BRL set_sprite_animation		;$B9D049  /
...
;START OF PATCH (animation offset calculation)
CODE_B9D0B8:
	LDY $66					;$B9D0B8  \
	STA $0000,y				;$B9D0BA   |
	CPY #$16B2				;$B9D0BD   | if diddy set animation with no offset
	BEQ set_sprite_animation		;$B9D0C0   |
	CPY #$16D8
	BEQ set_dixie_anim_offset
	CPY #!donkey_variables_address
	BEQ set_donkey_anim_offset
	CLC
	ADC #!kiddy_animation_offset
	BRA set_sprite_animation
	
set_dixie_anim_offset:
	CLC
	ADC #$00A3
	BRA set_sprite_animation
set_donkey_anim_offset:
	CLC
	ADC #!donkey_animation_offset
	BRA set_sprite_animation
;END OF PATCH
...
;START OF PATCH (animation update)
CODE_B9DF7A:
	CMP $0597				;$B9DF7A  \
...
CODE_B9E9E1:
	...
	LDA #krook_anim_fix_pointer		;$B9E9E5   |
	STA $3C,x				;$B9E9E8   |
	STZ $38,x				;$B9E9EA   |
	STZ $3E,x				;$B9E9EC   |
CODE_B9E9EE:					;	   |
...
CODE_B9EAD0:
	...
	LDA #hot_air_balloon_anim_fix_pointer	;$B9EAD5   |
	STA $3C,x				;$B9EAD8   |
	STZ $3E,x				;$B9EADA   |
	RTS					;$B9EADC  /
