...
CODE_B3813E:
	LDA $19AB				;$B3813E  \
	CMP #$0100				;$B38141   |
	%lda_sound(6, flotsam_move)		;$B38144   |
...
CODE_B39336:
	...
	%lda_sound(6, king_zing_egg_bounce)	;$B3933D   |
...
CODE_B39393:
	JML [$05A9]				;$B39393  \
CODE_B39396:					;	   |
	LDA $060B				;$B39396   |\ get barralax flag
	AND #$0001				;$B39399   | |
...
CODE_B393B1:					;	   |
	...
	BCS CODE_B39393				;$B393B4   | sprite done
...
CODE_B3A465:
	...
	%lda_sound(5, zinger_flitter_hit)	;$B3A47F   |
...
CODE_B3A99F:
	...
	%lda_sound(5, click_clack_hit)		;$B3A9BE   |
...
;START OF PATCH (move wind patterns to free space in FF)
CODE_B3DB57:
