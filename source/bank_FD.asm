...
incbin "kong_hack/dkc2_secret_ending_with_kiddy_pal.bin"
...
;START OF PATCH (kong dk barrel/donkey/kiddy palettes)
	...
	dw donkey_player_palette					; 008C
	dw kiddy_player_palette						; 008D
