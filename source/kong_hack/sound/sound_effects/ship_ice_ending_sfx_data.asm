...
;START OF PATCH (replace sound effect 64)
	dw .k_rool_note	;64: Read K. Rool's note
;	dw .seq_30BA	;64: -Nothing-
;END OF PATCH
	dw .seq_30A2	;65: Enguarde bill attack
	dw .seq_2FA2	;66: Enguarde hit
;START OF PATCH (replace sound effect 67)
	dw .seq_30BA	;67: -Nothing-
...
;START OF PATCH (add sequence data for K. Rool note sound)
.k_rool_note:
...
;START OF PATCH (remove sound effect 67)
;.seq_308A:
