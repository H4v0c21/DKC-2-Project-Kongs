...
;START OF PATCH (remove unused sequence data 1/3)
;.unreached_1364:
;	db !return_from_sub
;END OF PATCH
...
.seq_144A:
;START OF PATCH (remove glitched closed hi-hat instrument, Hit Target)
;	db !change_instr_pitch, $00
;	db !fine_tune, $00
...
.seq_14B3:
	...
	db $98, $25
	db !pitch_slide_off
;START OF PATCH (remove glitched closed hi-hat instrument, Dixie Victory)
	db !end_sequence
...
.seq_165B:
	...
	db $9A, $20
	db !pitch_slide_off
;START OF PATCH (remove glitched closed hi-hat instrument, Diddy Victory)
;	db !change_instr_pitch, $00
;	db !fine_tune, $00
;	db !set_instrument, $2E
;	db !set_volume_l_and_r, $14, $1E
...
;START OF PATCH (remove unused sequence data, 2/3)
;.unreached_19B4:
...
;START OF PATCH (remove unused sequence data, 3/3)
;.unreached_22E4:
;	db !set_instrument, $9C
;	db !change_instr_pitch, $00
;	db !fine_tune, $00
