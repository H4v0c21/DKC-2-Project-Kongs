...
;START OF PATCH (remove unused sequence data, 1/4)
;.unreached_1378:
;	db !end_sequence
;END OF PATCH
...
;START OF PATCH (remove unused sequence data, 2/4)
;.unreached_1525:
;	db $A0, $04
;	db $9D, $04
;	db $9D, $04
...
;START OF PATCH (remove unused sequence data, 3/4)
;.unreached_15F5:
;	db !set_adsr, $8F, $F2
;	db !set_instrument, $00
;	db !set_vol_single_val, $46
...
;START OF PATCH (remove unused sequence data, 4/4)
;.unreached_16AD:
;	db !set_volume_l_and_r, $32, $1E
;	db $97, $08
;	db $95, $08
