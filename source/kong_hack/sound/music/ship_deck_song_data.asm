...
;START OF PATCH (remove unused sequence data, 1/6)
;.unreached_1464:
...
;START OF PATCH (remove unused sequence data, 2/6)
;.unreached_14D6:
;	db !set_volume_l_and_r, $1E, $1E
...
;START OF PATCH (remove unused sequence data, 3/6)
;.unreached_16A6:
;	db !set_volume_l_and_r, $1E, $1E
...
;START OF PATCH (remove unused sequence data, 4/6)
;.unreached_1A6E:
...
;START OF PATCH (remove unused sequence data, 5/6)
;.unreached_1E69:
;	db !set_volume_l_and_r, $26, $3C
;	db $97, $08
;	db $9B, $04
...
;START OF PATCH (remove unused sequence data, 6/6)
;.unreached_1F9E:
;	db !set_instrument, $21
