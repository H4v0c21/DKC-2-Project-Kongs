...
dw $0800	;terminal velocity
dw $005A	;gravity velocity when jumping
	dw $0800
dw $F800	;jump velocity
	dw $0120
dw $0200	;walk speed
dw $0300	;run speed

;dw $0007	;jump velocity blend strength 
;dw $0007	;walk velocity blend strength
;dw $0007	;run velocity blend strength
dw $000B	;jump velocity blend strength 
dw $000B	;walk velocity blend strength
dw $000B	;run velocity blend strength
...
dw $0360	;roll speed (from walking)
dw $0480	;roll speed (from running)
...
dw $0200	;up climb speed
dw $0280	;down climb speed
dw $0300	;fast up climb speed
dw $0380	;fast down climb speed
...
dw $FF00	;swim up speed (holding down)
	...
	dw $0140	;water terminal velocity (sink speed)
	dw $0240	;swim down speed (holding down)
dw $0180	;horizontal swim speed
dw $0280	;fast horizontal swim speed
