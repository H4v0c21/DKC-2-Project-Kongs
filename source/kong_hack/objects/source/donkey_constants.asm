	...
	dw $004A	;04 jump gravity force
	dw $0800	;06 max fall y velocity holding down?
	dw $F8C0	;08 jump y velocity
	dw $0120	;0A 
	...
	dw $0002	;1C 
	dw $0100	;1E idle roll x velocity
	dw $0300	;20 walk roll x velocity
	dw $0400	;22 run roll x velocity
	...
	dw $0180	;54 up single rope climb y velocity
	dw $0280	;56 down single rope climb y velocity
	dw $0280	;58 up single rope climb y velocity (holding y)
	dw $0380	;5A down single rope climb y velocity (holding y)
	...
	dw $0100	;7C swim x velocity
	dw $0200	;7E swim x velocity (holding y)
