...
kong_variable_addresses:
	dw $16B2
	dw $16D8
	dw !donkey_variables_address		;these need to be moved somewhere with free space
	dw !kiddy_variables_address		;these need to be moved somewhere with free space

get_kong_sprite_address:
	ASL
	TAX
	LDA.l kong_sprite_addresses,x
	RTL

get_kong_variable_addresses:
	ASL
	TAX
	LDA.l kong_variable_addresses,x
	RTL
...
get_kong_spr_and_var_addrs_common:
	...
	AND #$00FF
	STA $08A4
	INC A				;might need to be changed
	STA $08A2			;might need to be changed
...
CODE_80A4B7:
	...
	%lda_sound(6, ending_k_rool_laugh)	;$80A4BE   |
	JSL play_high_priority_sound		;$80A4C1   |
	%lda_sound(7, ending_k_rool_laugh_echo)	;$80A4C5   |
...
if !file_select_override == 1
	JML !file_select_override_routine
endif
...
;START OF PATCH (new rareware logo palette)
DATA_80B377:
	%offset(DATA_80B378, 1)
	%offset(DATA_80B379, 2)
	incbin "kong_hack/screens/palettes/h4v0c21_logo_palette.bin"
;END OF PATCH

;rareware logo palette
...
;START OF PATCH (add kongs to ending parade)
	...
	BEQ .diddy				;$80F503   |
	CMP #$020C				;$80F505   |
	BEQ dixie_parade_handler
	CMP #$0212
	BEQ .donkey
	CMP #$0214
	BEQ .kiddy
	BRA CODE_80F533				;$80F50A  /
...
DATA_80F70C:
	...
	dw DATA_80F92C
	dw DATA_80F933
;START OF PATCH (add kongs to end parade)
	dw kiddy_parade_text
	dw donkey_parade_text
;END OF PATCH
	dw DATA_80F93A
	dw DATA_80F940
