...
if !version == 0				;	   |
	...
	LDA #$0029				;$B88DA1   | play diddy hurt sound
...
;START OF PATCH (kong animal offset)
	...
	LDA $08A4
	BEQ diddy_active_animal_offset
	CMP #$0001
	BEQ dixie_active_animal_offset
	CMP #$0002
	BEQ donkey_active_animal_offset
	
	LDA.l kiddy_animal_offset_a,x
	STA $0D72
	LDA.l kiddy_animal_offset_b,x
	STA $0D74
	BRA CODE_B89417
	
	
donkey_active_animal_offset:
	LDA.l donkey_animal_offset_a,x
	STA $0D72
	LDA.l donkey_animal_offset_b,x
	STA $0D74
	BRA CODE_B89417
...
;End of code
	...
	PHA					;$B8A9E4   |
;Start of code
.do_not_push_current_sprite_to_stack:
;End of code
